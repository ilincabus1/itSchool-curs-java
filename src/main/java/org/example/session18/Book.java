...
public class Book {
    ...
    private String isbn;
    public Book(String title, String author, int numPages, String isbn) {
        this.title = title;
        this.author = author;
...
class LibraryDemo {
    public static void main(String[] args) {
        Book b1 = new Book("Clean code","Robert C. Martin", 464, "123456");
        Book b2 = new Book("Clean code","Robert C. Martin", 464, "123456");
        Book b3 = new Book("Effective Java", "Joshua Bloch", 416, "987654");
        ...
        Book b4 = new Book("Apocalipsa", "Stephen King", 1000, "456123");
        ...
        inventory.put(b1,10);
        inventory.put(b3,4);
        inventory.put(b2,15); //suprascrie valoarea initiala pusa pe b1 pentru ca b1 equals b2
