...
public class PizzaOrderSystem {
    public static void main(String[] args) {
        List<PizzaOrder> orders = List.of(
                new PizzaOrder("Margherita", List.of("Mozzarella"), 30),
                new PizzaOrder("Pepperoni", List.of("Meat", "Peppers"), 40),
                new PizzaOrder("Vegetarian", List.of("Olives", "Peppers", "Mushrooms"), 50),
                new PizzaOrder("Margherita", List.of("Pineapple"), 50)
        );
